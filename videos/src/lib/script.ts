...
export interface BulletScene {
  /** 1-based bullet number from how-it-works.md (1..17). */
  id: number;
  /** Heading text — appears on the title card. */
  title: string;
  /** Kebab-case content slug. Drives audio file naming and any future
   *  per-bullet permalink. */
  slug: string;
...
export interface Chapter {
  ...
  title: string;
  /** Kebab-case slug used for file names and the docs-site URL. */
  slug: string;
...
export const chapters: Record<1 | 2 | 3, Chapter> = {
  1: { number: 1, slug: "introducing-worca", title: "Introducing worca", scenes: v1 },
  2: { number: 2, slug: "inside-a-worca-run", title: "Inside a worca run", scenes: v2 },
  3: { number: 3, slug: "worca-in-your-workflow", title: "Worca in your workflow", scenes: v3 },
};
